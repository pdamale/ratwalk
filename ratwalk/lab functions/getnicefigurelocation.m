function figure_size = getnicefigurelocation(figure_size, figure_units)
%% Calculate Figure Location
% adjust the specified figure position to fig nicely over GCBF
% or into the upper 3rd of the screen.  This is renamed from a private function 
% to uitools that ships with MATLAB call GETNICEDIALOGLOCATION
% see: >> which getnicedialoglocation in questdlg
